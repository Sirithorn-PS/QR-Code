...
- **3-Tier Role Separation**:
  - `admin`: ผู้ดูแลระบบบัญชีผู้ใช้งาน (User Management, อนุมัติ/ระงับ/เปิดใช้งานบัญชี) ไม่มีสิทธิ์ Confirm/Reject รายการคลังสินค้า
  - `supervisor`: ผู้ควบคุมดูแลกระบวนการคลังสินค้า ตรวจสอบสต็อก/Lot/FIFO และมีสิทธิ์ Confirm/Reject รายการคลังสินค้า
  - `warehouse_staff`: พนักงานคลังสินค้า สแกน QR Code เพื่อสร้างรายการรับเข้า/จ่ายออก
