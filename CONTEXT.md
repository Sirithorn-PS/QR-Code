...
ผู้ใช้หลัก:
- `warehouse_staff`: พนักงานคลังสินค้า สแกน QR Code สร้างรายการรับเข้า/จ่ายออกรอการยืนยัน
- `supervisor`: ผู้ควบคุมดูแลคลังสินค้า ตรวจสอบ/อนุมัติรายการ (Confirm/Reject), ดูแลสต็อก Packaging, Lot, FIFO Allocation และ BOM
- `admin`: ผู้ดูแลระบบด้านบัญชีผู้ใช้งาน (User Management, อนุมัติ/ระงับ/เปิดใช้งานบัญชีผู้ใช้)
