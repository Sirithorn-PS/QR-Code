...
- **ปรับปรุงดีไซน์หน้าจัดการสต็อกให้โฟกัสเฉพาะ Packaging (Packaging Stock Redesign) และอัปเกรดระบบสแกน View-Only สำหรับสินค้ากลุ่มอื่น**:
  - **ปรับเปลี่ยนหน้าสต็อก (`frontend/app/inventory/page.tsx`)**:
    ...
    6. ปรับการ์ดสรุปตัวเลขสถิติภาพรวมบรรจุภัณฑ์ 6 หมวดหมู่ (`บรรจุภัณฑ์ทั้งหมด`, `แกลลอน`, `ฟอยล์`, `ฝา`, `กล่อง`, `อื่นๆ`) ให้เป็น **ปุ่มกดตัวกรองข้อมูลแบบโต้ตอบโดยตรง (Interactive Filter Cards)** โดยปรับแต่งเส้นกรอบของกล่องไอคอนให้เป็น **เส้นกรอบสีแดงอ่อนสไตล์แบรนด์ ENEOS (`border-red-200/80 text-[#BE1111] bg-red-50/50`)** แทนกรอบสีเทาเดิม พร้อมจัดวางองค์ประกอบแบบแนวตั้งตรงกลางสมดุล 100% (Center-Aligned Vertical Stack) และใช้ **เส้นกรอบสีแดงพรีเมียมแบรนด์ ENEOS (`border-2 border-[#BE1111]`)** บนการ์ดที่ถูกเลือก คมชัดสวยงามสไตล์ Apple Clean Slate
