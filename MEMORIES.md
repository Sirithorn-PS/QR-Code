...
- **ปรับปรุงดีไซน์ Header / โลโก้ในหน้าเข้าสู่ระบบ (Login) และหน้าลงทะเบียน (Register)**:
  ...
  - ปรับแต่งดีไซน์แถบเมนูหลัก (Navbar) ใหม่ทั้งหมดแบบกระชับมินิมอล 100% Overflow-proof: นำชุดคำอธิบายยาวและชิปบทบาทหน้าที่ออกจาก Header แถบบน (ช่วยคืนพื้นที่กว่า 380px), ปรับขนาดปุ่มเมนูให้กะทัดรัดเรียบหรู ป้องกันการล้นตกขอบขวาอย่างสมบูรณ์แบบบนทุกอุปกรณ์และทุกความละเอียดหน้าจอตามมาตรฐาน `DESIGN.md`
