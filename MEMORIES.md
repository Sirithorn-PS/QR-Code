...
- **ปรับปรุงดีไซน์หน้าจัดการสต็อกให้โฟกัสเฉพาะ Packaging (Packaging Stock Redesign) และอัปเกรดระบบสแกน View-Only สำหรับสินค้ากลุ่มอื่น**:
  ...
  - **ปรับปรุงหน้าสแกน QR Code (`frontend/app/scan/page.tsx`)**:
    1. หากสแกน QR Code สินค้าประเภท **Packaging**: รองรับการทำรายการสแกนรับเข้า (Check-in) และจ่ายออก (Check-out) ได้ตามปกติ
    2. หากสแกน QR Code สินค้าประเภทอื่น (**FG**, **Bulk**, **Raw Material**): ปรับให้แสดงข้อมูลแบบ **ดูได้อย่างเดียว (View-Only Mode)** สำหรับดูสูตร BOM พร้อมแสดงป้ายแจ้งเตือนชัดเจน *"ℹ️ รายการนี้สำหรับดูข้อมูล BOM เท่านั้น (ไม่อนุญาตให้สแกนรับเข้า-เบิกออก)"* และซ่อนฟอร์มป้อนจำนวนพร้อมปุ่มยืนยันทำรายการ
