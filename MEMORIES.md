...
- **ปรับปรุงดีไซน์ Header / โลโก้ในหน้าเข้าสู่ระบบ (Login) และหน้าลงทะเบียน (Register)**:
  ...
  - ปรับแต่งดีไซน์แถบเมนูหลัก (Navbar) ใหม่แบบกระชับมินิมอล 100% Overflow-proof: คงข้อความคำอธิบายภาษาอังกฤษ 2 บรรทัด (`Packaging Material` / `Warehouse Management System`) ไว้ข้างโลโก้ตามคำขอของผู้ใช้ ปรับขนาดฟอนต์และ Padding ของทุกองค์ประกอบให้ได้สัดส่วนกะทัดรัด ป้องกันการล้นตกขอบขวาอย่างสมบูรณ์แบบบนทุกอุปกรณ์และทุกความละเอียดหน้าจอตามมาตรฐาน `DESIGN.md`
