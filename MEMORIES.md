...
- **ปรับปรุงดีไซน์ Header / โลโก้ในหน้าเข้าสู่ระบบ (Login) และหน้าลงทะเบียน (Register)**:
  ...
  - ปรับแต่งดีไซน์แถบเมนูหลัก (Navbar) ให้ข้อความและไอคอนมีขนาดใหญ่ขึ้น ชัดเจน อ่านง่าย สบายตา (`text-sm xl:text-base`) พร้อมคงข้อความภาษาอังกฤษ 2 บรรทัด (`Packaging Material` / `Warehouse Management System`) ไว้ข้างโลโก้อย่างสวยงามตามคำขอของผู้ใช้ โดยจำกัดการแก้ไขเฉพาะส่วนแถบเมนูด้านบนเท่านั้นตามมาตรฐาน `DESIGN.md`
