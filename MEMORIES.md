...
- **ปรับปรุงดีไซน์ Header / โลโก้ในหน้าเข้าสู่ระบบ (Login) และหน้าลงทะเบียน (Register)**:
  ...
  - ปรับแต่งดีไซน์แถบเมนูหลัก (Navbar) ทั้งแบบ Desktop และ Mobile/Tablet แบบยกระดับความสวยงาม: แสดงไอคอนกล่องพัสดุสีแดงแบบเดี่ยวโดยนำกรอบพื้นหลังออก, นำเงาสีแดงรอบวงกลม Avatar ออกตามคำขอของผู้ใช้, ป้องกันข้อความและปุ่มตกขอบขวาเพี้ยนบนโทรศัพท์/แท็บเล็ต โดยสลับไปใช้ Mobile Layout อัตโนมัติเมื่อหน้าจอเล็กกว่า `lg` (1024px) พร้อมเพิ่มไอคอน Avatar และปุ่มออกจากระบบบน Mobile Top Header อย่างสมบูรณ์แบบตามมาตรฐาน `DESIGN.md`
